		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nlstar4itweb-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nlstar4itweb-display": {
								"semanticObject": "nlstar4itweb",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nl.star4it.web",
									"url": sap.ui.require.toUrl("nl/star4it/web")
								}
							}
						}
					}
